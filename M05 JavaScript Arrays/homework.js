...
function cuentoElementos(array) {
   ...
   for( var i = 0; i < array.length; i++){
      if ( array [i] > 18);
      elementosMayores = elementosMayores + (array [i]> 18);
   } 
...
function todosIguales(array) {
   ...
   // Tu código:
   elementosArreglo= array[0]
   for( let i= 0; i< array.length; i++){
      if( array[i] !== elementosArreglo){
      return false;
   }
   }
   return true; 
